        ...
        <div class="col-md-8">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Ayah</li>
                </ol>
            </nav>
            ...
            <div class="card">
                ...
                <form action="{{route('registrant.father.store')}}" method="post">
                    <div class="card-body">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="year_of_birth" id="year_of_birth" class="form-control form-control-sm @if ($errors->has('year_of_birth')) is-invalid @endif" value="{{!empty($learner->father->year_of_birth) ? Carbon\Carbon::parse($learner->father->year_of_birth)->format('Y') : old('year_of_birth')}}" placeholder="Masukan tahun lahir disini">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="last_study" id="last_study" class="form-control form-control-sm @if ($errors->has('last_study')) is-invalid @endif" value="{{$learner->father->last_study ?? old('last_study')}}" placeholder="Masukan pendidikan terakhir disini">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="profession" id="profession" class="form-control form-control-sm @if ($errors->has('profession')) is-invalid @endif" value="{{$learner->father->profession ?? old('profession')}}" placeholder="Masukan pekerjaan disini">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="phone" id="phone" class="form-control form-control-sm @if ($errors->has('phone')) is-invalid @endif" value="{{$learner->father->phone ?? old('phone')}}" placeholder="Masukan no. telp/hp disini">
